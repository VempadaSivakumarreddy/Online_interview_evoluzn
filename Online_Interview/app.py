...
class Question:
    ...
    def __init__(self, q_id, question, option1, option2, option3, option4, correctOption,QuestionType):
...
def RandomQuestions(questionSubj):
    ...
    randomQestions =  GetQuestions(cursor, 25,questionSubj)
    ...
    for row in randomQestions :
        ...
        if QuestionType == "MCQ":
            ...
            tempQuestion = Question(row['idquestions'],row['question'],randomizedOptions[0],randomizedOptions[1],randomizedOptions[2],randomizedOptions[3],correctAnsIndx,QuestionType)
            questions_list.append(tempQuestion)

        elif QuestionType == "Text":
            correctAns = row['CorrectAnswer']
            tempQuestion = Question(row['idquestions'],row['question'],0,0,0,0,0,QuestionType)
...
def submitquiz():
    ...
    if request.method == 'POST':
        ...
        if msg:
            cursor.execute('select * from score where SrNo = %s and idquiz = %s', (msg['idquiz'], [SrNo]))
            found = cursor.fetchone()
            # create a table for a  test per user
            # mycursor.execute("CREATE TABLE {tableName} (name VARCHAR(255), address VARCHAR(255))".format(tableName = email))
            ...
            if not found:
                ...
                Question16 = Question[15]
                Question17 = Question[16]
                Question18 = Question[17]
                Question19 = Question[18]
                Question20 = Question[19]
                Question21 = Question[20]
                Question22 = Question[21]
                Question23 = Question[22]
                Question24 = Question[23]
                Question25 = Question[24]
                ...
                correct_option16 = correct_option[15]
                correct_option17 = correct_option[16]
                correct_option18 = correct_option[17]
                correct_option19 = correct_option[18]
                correct_option20 = correct_option[19]
                correct_option21 = correct_option[20]
                correct_option22 = correct_option[21]
                correct_option23 = correct_option[22]
                correct_option24 = correct_option[23]
                correct_option25 = correct_option[24]
                ...
                selected_option16 = selected_option[15]
                selected_option17 = selected_option[16]
                selected_option18 = selected_option[17]
                selected_option19 = selected_option[18]
                selected_option20 = selected_option[19]
                selected_option21 = selected_option[20]
                selected_option22 = selected_option[21]
                selected_option23 = selected_option[22]
                selected_option24 = selected_option[23]
                selected_option25 = selected_option[24]
                ...
                sql16 = "INSERT INTO score_count (start_time,end_time,total_count, idquiz,Question,correct_option,selected_option) VALUES(%s,%s,%s,%s,%s,%s,%s)"
                cursor.execute(sql16, (start_time,time.strftime('%Y-%m-%d %H:%M:%S'),
                    total_count, msg['idquiz'], Question16, correct_option16, selected_option16))
                sql17 = "INSERT INTO score_count (start_time,end_time,total_count, idquiz,Question,correct_option,selected_option) VALUES(%s,%s,%s,%s,%s,%s,%s)"
                cursor.execute(sql17, (start_time,time.strftime('%Y-%m-%d %H:%M:%S'),
                    total_count, msg['idquiz'], Question17, correct_option17, selected_option17))
                sql18 = "INSERT INTO score_count (start_time,end_time,total_count, idquiz,Question,correct_option,selected_option) VALUES(%s,%s,%s,%s,%s,%s,%s)"
                cursor.execute(sql18, (start_time,time.strftime('%Y-%m-%d %H:%M:%S'),
                    total_count, msg['idquiz'], Question18, correct_option18, selected_option18))
                sql19 = "INSERT INTO score_count (start_time,end_time,total_count, idquiz,Question,correct_option,selected_option) VALUES(%s,%s,%s,%s,%s,%s,%s)"
                cursor.execute(sql19, (start_time,time.strftime('%Y-%m-%d %H:%M:%S'),
                    total_count, msg['idquiz'], Question19, correct_option19, selected_option19))
                sql20 = "INSERT INTO score_count (start_time,end_time,total_count, idquiz,Question,correct_option,selected_option) VALUES(%s,%s,%s,%s,%s,%s,%s)"
                cursor.execute(sql20, (start_time,time.strftime('%Y-%m-%d %H:%M:%S'),
                    total_count, msg['idquiz'], Question20, correct_option20, selected_option20))
                sql21 = "INSERT INTO score_count (start_time,end_time,total_count, idquiz,Question,correct_option,selected_option) VALUES(%s,%s,%s,%s,%s,%s,%s)"
                cursor.execute(sql21, (start_time,time.strftime('%Y-%m-%d %H:%M:%S'),
                    total_count, msg['idquiz'], Question21, correct_option21, selected_option21))
                sql22 = "INSERT INTO score_count (start_time,end_time,total_count, idquiz,Question,correct_option,selected_option) VALUES(%s,%s,%s,%s,%s,%s,%s)"
                cursor.execute(sql22, (start_time,time.strftime('%Y-%m-%d %H:%M:%S'),
                    total_count, msg['idquiz'], Question22, correct_option22, selected_option22))
                sql23 = "INSERT INTO score_count (start_time,end_time,total_count, idquiz,Question,correct_option,selected_option) VALUES(%s,%s,%s,%s,%s,%s,%s)"
                cursor.execute(sql23, (start_time,time.strftime('%Y-%m-%d %H:%M:%S'),
                    total_count, msg['idquiz'], Question23, correct_option23, selected_option23))
                sql24 = "INSERT INTO score_count (start_time,end_time,total_count, idquiz,Question,correct_option,selected_option) VALUES(%s,%s,%s,%s,%s,%s,%s)"
                cursor.execute(sql24, (start_time,time.strftime('%Y-%m-%d %H:%M:%S'),
                    total_count, msg['idquiz'], Question24, correct_option24, selected_option24))
                sql25 = "INSERT INTO score_count (start_time,end_time,total_count, idquiz,Question,correct_option,selected_option) VALUES(%s,%s,%s,%s,%s,%s,%s)"
                cursor.execute(sql25, (start_time,time.strftime('%Y-%m-%d %H:%M:%S'),
                    total_count, msg['idquiz'], Question25, correct_option25, selected_option25))
